            ...
            <ul>
              <li className="skills-item">
                <div className="skills-item-inner"> 
                  <div className="skills-item-content">
                    <h3>Oil Painting</h3>
                    <p>Drawing and painting have always been cherished hobbies of mine. 
                      Experimenting with various colors and techniques, particularly in the portrayal of people, brings me great joy. 
                      These artistic pursuits serve as an excellent means of relaxation and stress relief when life becomes demanding, as well as providing a delightful pastime during periods of leisure.</p>
                  </div>
              ...
              <li className="skills-item">
                <div className="skills-item-inner"> 
                  <div className="skills-item-content">
                    <h3>Crocheting</h3>
                    <p>Engaging in repetitive motions can have a soothing effect on the mind, making it an effective technique for relaxation. 
                      ...
                      Therefore, it is a great way to unwind and take a break from the daily grind.</p>
                  </div>
              ...
              <li className="skills-item">
                <div className="skills-item-inner"> 
                  <div className="skills-item-content">
                    <h3>Learning</h3>
                    <p>While often overlooked, I firmly believe that learning is a skill in and of itself. 
                      ...
                      This approach has allowed me to retain a greater amount of information over time.</p>
                  </div>
