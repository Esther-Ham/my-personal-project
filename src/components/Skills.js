...
const otherSkills = "My Other Skills"
const firstSkill = "Oil Painting"
const secondSkill = "Crocheting"
const thirdSkill = "Learning"
      ...
      <div className="wide-tile">
        <article className="tile is-child box wide-tile">
          <div className="title-container">
            <h2 className='custom-h2'>{otherSkills}</h2>
          </div>
